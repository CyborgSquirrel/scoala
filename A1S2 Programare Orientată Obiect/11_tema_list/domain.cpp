...
size_t Carte::get_id() const { return this->id; }
...
InchiriereCarte::InchiriereCarte(size_t carte_id) : carte_id(carte_id) { }
size_t InchiriereCarte::get_carte_id() const { return this->carte_id; }
