...
void testIterator() {
	cout << "\ttestIterator(cresc);" << endl; testIterator(cresc);
	cout << "\ttestIterator(desc);" << endl; testIterator(desc);
}

void testAllExtins() {
	cout << "testCreeaza();" << endl; testCreeaza();
	cout << "testCauta();" << endl; testCauta();
	cout << "testSterge();" << endl; testSterge();
	cout << "testIterator();" << endl; testIterator();
}
