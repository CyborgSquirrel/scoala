...
export const makeAuthResponse = (): [null|AuthResponse, Dispatch<SetStateAction<null|AuthResponse>>] => {
  return makeStorable<null|AuthResponse>(
    "authResponse",
    null,
    window.localStorage,
  );
...
export const makeQuestions = (): [null|Question[], Dispatch<SetStateAction<null|Question[]>>] => {
  return makeStorable<null|Question[]>(
    "question",
    null,
    window.localStorage,
  );
