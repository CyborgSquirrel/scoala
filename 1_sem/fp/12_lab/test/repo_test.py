...
class TestInMemoryGradeRepo(unittest.TestCase):
	...
	def test_get_student_grade_dtos(self):
		repo = InMemoryGradeRepo()
		grades = [Grade(1, 1, 1, 5), Grade(2, 1, 2, 8), Grade(3, 2, 1, 7), Grade(4, 2, 2, 4),]
		...
		self.assertEqual(len(grades), len(repo.get_student_grade_dtos()))
