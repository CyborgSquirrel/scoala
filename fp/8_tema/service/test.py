...
def test_get_grades_with_discipline_sorted_by_criterion():
	...
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(1, "name") \
		== [ 5, 1, 2 ]
	
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(2, "name") \
		== [ 6, 3 ]
	
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(3, "name") \
		== [ 7, 4 ]
	
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(1, "grade") \
		== [ 5, 1, 2 ]
	
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(2, "grade") \
		== [ 6, 3 ]
	
	assert grade_service.get_grades_with_discipline_sorted_by_criterion(3, "grade") \
		== [ 7, 4 ]
...
def test_get_top_20_percent_of_students():
	...
	assert grade_service.get_top_20_percent_of_students() == [ (2,(10+9.5+9.75)/3) ]
