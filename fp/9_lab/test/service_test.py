...
def test_get_top_3_students_by_average():
	student_service, discipline_service, grade_service = \
		__init_grade_service_and_its_dependencies()
	...
	try:
		...
		assert ex.get_errors() == "too few students\n"
	...
	assert top_3_students[0].get_student_name() == "Andrei"
	assert top_3_students[0].get_average() == (9.7+8)/2
	assert top_3_students[1].get_student_name() == "Andrei'"
	assert top_3_students[1].get_average() == (5.2+10)/2
	assert top_3_students[2].get_student_name() == "Andrei'''"
	assert top_3_students[2].get_average() == (8.3+6.2)/2
...
def run_service_tests():
	...
	test_get_top_3_students_by_average()
	test_erase_grade()
