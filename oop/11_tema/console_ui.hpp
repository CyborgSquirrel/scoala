...
public:
	ConsoleUi(SrvCarti &srv_carti, SrvInchirieriCarte &srv_inchirieri_carte);
...
class ConsoleUiAction {
private:
	std::string name;
	void (ConsoleUi::*method)();
public:
	ConsoleUiAction(std::string name, void (ConsoleUi::*method)());
	std::string get_name() const;
	void execute(ConsoleUi &ui) const;
};
